...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=crpi-qjc1bm88klc3y8ne.cn-hangzhou.personal.cr.aliyuncs.com/imdct/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=im-${SERVER_NAME}-${SERVER_TYPE}-test
