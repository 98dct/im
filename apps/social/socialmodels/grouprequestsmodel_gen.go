...
type (
	groupRequestsModel interface {
		Trans(ctx context.Context, f func(ctx context.Context, session sqlx.Session) error) error
...
func (m *defaultGroupRequestsModel) Trans(ctx context.Context, f func(ctx context.Context, session sqlx.Session) error) error {
